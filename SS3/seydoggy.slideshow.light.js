/**
 * SeydoggySlideshow (sans dependencies)
 * the built-in slider for RapidWeaver themes
 *
 * Latest version: https://github.com/seyDoggy/SeydoggySlideshow
 *
 * License <https://github.com/seyDoggy/SeydoggySlideshow/blob/master/LICENSE.txt>
 */

// initiate sdSS object
if (!window.sdSS) sdSS = {};

// make SeydoggySlideshow plugin
(function($) {
    $.SeydoggySlideshow = function(settings) {
        var pluginName = 'SeydoggySlideshow',
        pluginVersion = '3.2.4';
